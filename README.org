...
#+begin_quote
[!NOTE]
Puedes consultar ejemplos de cómo realizar llamadas a la API de AWS desde JavaScript en la [[https://docs.aws.amazon.com/sdk-for-javascript/v3/developer-guide/javascript_code_examples.html][documentación]]. También puedes consultar la [[https://docs.aws.amazon.com/AWSJavaScriptSDK/v3/latest/][referencia de la API de JavaScript]].
